...
static union _zend_function *spl_recursive_it_get_method(zval **object_ptr, char *method, zend_string_size method_len, const zend_literal *key TSRMLS_DC)
{
...
static union _zend_function *spl_dual_it_get_method(zval **object_ptr, char *method, zend_string_size method_len, const zend_literal *key TSRMLS_DC)
{
	union _zend_function *function_handler;
