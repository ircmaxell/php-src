...
static int php_valid_var_name(char *var_name, zend_string_size var_name_len) /* {{{ */
{
	int i, ch;
...
PHPAPI int php_prefix_varname(zval *result, zval *prefix, char *var_name, zend_string_size var_name_len, zend_bool add_underscore TSRMLS_DC) /* {{{ */
{
