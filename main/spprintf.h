...
BEGIN_EXTERN_C()
PHPAPI zend_string_size spprintf( char **pbuf, zend_string_size max_len, const char *format, ...) PHP_ATTRIBUTE_FORMAT(printf, 3, 4);

PHPAPI zend_string_size vspprintf(char **pbuf, zend_string_size max_len, const char *format, va_list ap) PHP_ATTRIBUTE_FORMAT(printf, 3, 0);
END_EXTERN_C()
