...
PHPAPI char* _php_glob_stream_get_path(php_stream *stream, int copy, zend_string_size *plen STREAMS_DC TSRMLS_DC);
#define php_glob_stream_get_path(stream, copy, plen)	_php_glob_stream_get_path((stream), (copy), (plen) STREAMS_CC TSRMLS_CC)

PHPAPI char* _php_glob_stream_get_pattern(php_stream *stream, int copy, zend_string_size *plen STREAMS_DC TSRMLS_DC);
