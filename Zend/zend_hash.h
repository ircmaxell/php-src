...
typedef ulong (*hash_func_t)(const char *arKey, zend_string_size nKeyLength);
...
ZEND_API int _zend_hash_add_or_update(HashTable *ht, const char *arKey, zend_string_size nKeyLength, void *pData, uint nDataSize, void **pDest, int flag ZEND_FILE_LINE_DC);
...
ZEND_API int _zend_hash_quick_add_or_update(HashTable *ht, const char *arKey, zend_string_size nKeyLength, ulong h, void *pData, uint nDataSize, void **pDest, int flag ZEND_FILE_LINE_DC);
...
ZEND_API int zend_hash_add_empty_element(HashTable *ht, const char *arKey, zend_string_size nKeyLength);
...
/* Deletes */
ZEND_API int zend_hash_del_key_or_index(HashTable *ht, const char *arKey, zend_string_size nKeyLength, ulong h, int flag);
...
ZEND_API ulong zend_get_hash_value(const char *arKey, zend_string_size nKeyLength);

/* Data retreival */
ZEND_API int zend_hash_find(const HashTable *ht, const char *arKey, zend_string_size nKeyLength, void **pData);
ZEND_API int zend_hash_quick_find(const HashTable *ht, const char *arKey, zend_string_size nKeyLength, ulong h, void **pData);
ZEND_API int zend_hash_index_find(const HashTable *ht, ulong h, void **pData);

/* Misc */
ZEND_API int zend_hash_exists(const HashTable *ht, const char *arKey, zend_string_size nKeyLength);
ZEND_API int zend_hash_quick_exists(const HashTable *ht, const char *arKey, zend_string_size nKeyLength, ulong h);
...
ZEND_API int zend_hash_get_current_key_ex(const HashTable *ht, char **str_index, zend_string_size *str_length, ulong *num_index, zend_bool duplicate, HashPosition *pos);
ZEND_API void zend_hash_get_current_key_zval_ex(const HashTable *ht, zval *key, HashPosition *pos);
ZEND_API int zend_hash_get_current_key_type_ex(HashTable *ht, HashPosition *pos);
ZEND_API int zend_hash_get_current_data_ex(HashTable *ht, void **pData, HashPosition *pos);
ZEND_API void zend_hash_internal_pointer_reset_ex(HashTable *ht, HashPosition *pos);
ZEND_API void zend_hash_internal_pointer_end_ex(HashTable *ht, HashPosition *pos);
ZEND_API int zend_hash_update_current_key_ex(HashTable *ht, int key_type, const char *str_index, zend_string_size str_length, ulong num_index, int mode, HashPosition *pos);
...
static inline ulong zend_inline_hash_func(const char *arKey, zend_string_size nKeyLength)
{
...
ZEND_API ulong zend_hash_func(const char *arKey, zend_string_size nKeyLength);
...
static inline int zend_symtable_update(HashTable *ht, const char *arKey, zend_string_size nKeyLength, void *pData, uint nDataSize, void **pDest)					\
{
...
static inline int zend_symtable_del(HashTable *ht, const char *arKey, zend_string_size nKeyLength)
{
...
static inline int zend_symtable_find(HashTable *ht, const char *arKey, zend_string_size nKeyLength, void **pData)
{
...
static inline int zend_symtable_exists(HashTable *ht, const char *arKey, zend_string_size nKeyLength)
{
	ZEND_HANDLE_NUMERIC(arKey, nKeyLength, zend_hash_index_exists(ht, idx));
	return zend_hash_exists(ht, arKey, nKeyLength);
}

static inline int zend_symtable_update_current_key_ex(HashTable *ht, const char *arKey, zend_string_size nKeyLength, int mode, HashPosition *pos)
{
