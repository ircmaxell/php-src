...
ZEND_API zend_class_entry *zend_fetch_class(const char *class_name, zend_string_size class_name_len, int fetch_type TSRMLS_DC);
ZEND_API zend_class_entry *zend_fetch_class_by_name(const char *class_name, zend_string_size class_name_len, const zend_literal *key, int fetch_type TSRMLS_DC);
