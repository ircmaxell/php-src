...
ZEND_FUNCTION(get_object_vars)
{
	...
	zend_string_size key_len, prop_len;
	ulong num_index;
	zend_object *zobj;
...
static int same_name(const char *key, const char *name, zend_string_size name_len)
{
...
ZEND_FUNCTION(interface_exists)
{
	...
	zend_class_entry **ce;
	zend_string_size iface_name_len;
	int found;
	zend_bool autoload = 1;
	ALLOCA_FLAG(use_heap)
...
ZEND_FUNCTION(trait_exists)
{
	...
	zend_class_entry **ce;
	zend_string_size trait_name_len;
	int found;
	zend_bool autoload = 1;
	ALLOCA_FLAG(use_heap)
...
ZEND_FUNCTION(create_function)
{
	...
	zend_string_size eval_code_length, function_name_length, function_args_len, function_code_len;
	int retval;
	char *eval_name;
...
{
	char *extension_name;
	zend_string_size extension_name_len;
	char *lcname;
