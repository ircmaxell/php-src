...
#define ZEND_INI_MH(name) int name(zend_ini_entry *entry, char *new_value, zend_string_size new_value_length, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage TSRMLS_DC)
...
struct _zend_ini_entry {
	...
	char *value;
	zend_string_size value_length;

	char *orig_value;
	zend_string_size orig_value_length;
	int orig_modifiable;
	int modified;
...
ZEND_API int zend_alter_ini_entry(char *name, zend_string_size name_length, char *new_value, zend_string_size new_value_length, int modify_type, int stage);
ZEND_API int zend_alter_ini_entry_ex(char *name, zend_string_size name_length, char *new_value, zend_string_size new_value_length, int modify_type, int stage, int force_change TSRMLS_DC);
ZEND_API int zend_restore_ini_entry(char *name, zend_string_size name_length, int stage);
ZEND_API void display_ini_entries(zend_module_entry *module);

ZEND_API long zend_ini_long(char *name, zend_string_size name_length, int orig);
ZEND_API double zend_ini_double(char *name, zend_string_size name_length, int orig);
ZEND_API char *zend_ini_string(char *name, zend_string_size name_length, int orig);
ZEND_API char *zend_ini_string_ex(char *name, zend_string_size name_length, int orig, zend_bool *exists);

ZEND_API int zend_ini_register_displayer(char *name, zend_string_size name_length, void (*displayer)(zend_ini_entry *ini_entry, int type));
