...
ZEND_API int zend_check_property_access(zend_object *zobj, const char *prop_info_name, zend_string_size prop_info_name_len TSRMLS_DC) /* {{{ */
{
	zend_property_info *property_info;
	const char *class_name, *prop_name;
	zval member;
	zend_string_size prop_name_len;
 ...
 */
static inline zend_function *zend_check_private_int(zend_function *fbc, zend_class_entry *ce, char *function_name_strval, zend_string_size function_name_strlen, ulong hash_value TSRMLS_DC) /* {{{ */
{
	if (!ce) {
		return 0;
	}
...
ZEND_API int zend_check_private(zend_function *fbc, zend_class_entry *ce, char *function_name_strval, zend_string_size function_name_strlen TSRMLS_DC) /* {{{ */
{
...
static inline union _zend_function *zend_get_user_call_function(zend_class_entry *ce, const char *method_name, zend_string_size method_len) /* {{{ */
{
...
static union _zend_function *zend_std_get_method(zval **object_ptr, char *method_name, zend_string_size method_len, const zend_literal *key TSRMLS_DC) /* {{{ */
{
	zend_function *fbc;
...
static inline union _zend_function *zend_get_user_callstatic_function(zend_class_entry *ce, const char *method_name, zend_string_size method_len) /* {{{ */
{
...
ZEND_API zend_function *zend_std_get_static_method(zend_class_entry *ce, const char *function_name_strval, zend_string_size function_name_strlen, const zend_literal *key TSRMLS_DC) /* {{{ */
{
...
ZEND_API zval **zend_std_get_static_property(zend_class_entry *ce, const char *property_name, zend_string_size property_name_len, zend_bool silent, const zend_literal *key TSRMLS_DC) /* {{{ */
{
	zend_property_info *property_info;
	ulong hash_value;
...
ZEND_API zend_bool zend_std_unset_static_property(zend_class_entry *ce, const char *property_name, zend_string_size property_name_len, const zend_literal *key TSRMLS_DC) /* {{{ */
{
...
int zend_std_object_get_class_name(const zval *object, const char **class_name, zend_string_size *class_name_len, int parent TSRMLS_DC) /* {{{ */
{
	zend_object *zobj;
	zend_class_entry *ce;
	zobj = Z_OBJ_P(object);
