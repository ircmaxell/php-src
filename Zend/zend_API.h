...
#define INIT_OVERLOADED_CLASS_ENTRY_EX(class_container, class_name, class_name_len, functions, handle_fcall, handle_propget, handle_propset, handle_propunset, handle_propisset) \
	{															\
		...
		zend_string_size _len = class_name_len;								\
...
ZEND_API void zend_update_property_stringl(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, const char *value, zend_string_size value_length TSRMLS_DC);
...
ZEND_API int zend_update_static_property_stringl(zend_class_entry *scope, const char *name, zend_string_size name_length, const char *value, zend_string_size value_length TSRMLS_DC);
...
ZEND_API int add_property_long_ex(zval *arg, const char *key, zend_string_size key_len, long l TSRMLS_DC);
...
ZEND_API int add_property_resource_ex(zval *arg, const char *key, zend_string_size key_len, long r TSRMLS_DC);
...
ZEND_API void zend_delete_variable(zend_execute_data *ex, HashTable *ht, const char *name, zend_string_size name_len, ulong hash_value TSRMLS_DC);

ZEND_API int zend_delete_global_variable(const char *name, zend_string_size name_len TSRMLS_DC);

ZEND_API int zend_delete_global_variable_ex(const char *name, zend_string_size name_len, ulong hash_value TSRMLS_DC);
...
#define ZVAL_STRINGL(z, s, l, duplicate) do {	\
		...
		zval *__z = (z);						\
		Z_STRSIZE_P(__z) = (zend_string_size) __l;					\
...
{																					\
	char *_name = (name);															\
	zend_string_size namelen = strlen(_name);													\
