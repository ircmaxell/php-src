...
typedef union _zend_function *(*zend_object_get_method_t)(zval **object_ptr, char *method, zend_string_size method_len, const struct _zend_literal *key TSRMLS_DC);
...
typedef int (*zend_object_get_class_name_t)(const zval *object, const char **class_name, zend_string_size *class_name_len, int parent TSRMLS_DC);
...
BEGIN_EXTERN_C()
ZEND_API union _zend_function *zend_std_get_static_method(zend_class_entry *ce, const char *function_name_strval, zend_string_size function_name_strlen, const struct _zend_literal *key TSRMLS_DC);
ZEND_API zval **zend_std_get_static_property(zend_class_entry *ce, const char *property_name, zend_string_size property_name_len, zend_bool silent, const struct _zend_literal *key TSRMLS_DC);
ZEND_API zend_bool zend_std_unset_static_property(zend_class_entry *ce, const char *property_name, zend_string_size property_name_len, const struct _zend_literal *key TSRMLS_DC);
...
ZEND_API int zend_check_private(union _zend_function *fbc, zend_class_entry *ce, char *function_name_strval, zend_string_size function_name_strlen TSRMLS_DC);
