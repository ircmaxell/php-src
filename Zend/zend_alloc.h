...
ZEND_API char *zend_strndup(const char *s, zend_string_size length) ZEND_ATTRIBUTE_MALLOC;
...
ZEND_API char *_estrndup(const char *s, zend_string_size length ZEND_FILE_LINE_DC ZEND_FILE_LINE_ORIG_DC) ZEND_ATTRIBUTE_MALLOC;
