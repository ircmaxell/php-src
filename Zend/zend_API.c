...
static int parse_arg_object_to_string(zval **arg, char **p, zend_string_size *pl, int type TSRMLS_DC) /* {{{ */
{
		...
		case 's':
			{
				...
				zend_string_size *pl = va_arg(*va, zend_string_size *);
				switch (Z_TYPE_PP(arg)) {
					case IS_NULL:
						if (check_null) {
							*p = NULL;
...
ZEND_API int add_assoc_long_ex(zval *arg, const char *key, zend_string_size key_len, long n) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_assoc_null_ex(zval *arg, const char *key, zend_string_size key_len) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_assoc_bool_ex(zval *arg, const char *key, zend_string_size key_len, int b) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_index_stringl(zval *arg, ulong index, const char *str, zend_string_size length, int duplicate) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_get_assoc_stringl_ex(zval *arg, const char *key, zend_string_size key_len, const char *str, zend_string_size length, void **dest, int duplicate) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_get_index_stringl(zval *arg, ulong index, const char *str, zend_string_size length, void **dest, int duplicate) /* {{{ */
{
	zval *tmp;
...
ZEND_API int add_property_long_ex(zval *arg, const char *key, zend_string_size key_len, long n TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_bool_ex(zval *arg, const char *key, zend_string_size key_len, int b TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_null_ex(zval *arg, const char *key, zend_string_size key_len TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_resource_ex(zval *arg, const char *key, zend_string_size key_len, long n TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_double_ex(zval *arg, const char *key, zend_string_size key_len, double d TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_string_ex(zval *arg, const char *key, zend_string_size key_len, const char *str, int duplicate TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_stringl_ex(zval *arg, const char *key, zend_string_size key_len, const char *str, zend_string_size length, int duplicate TSRMLS_DC) /* {{{ */
{
	zval *tmp;
	zval *z_key;
...
ZEND_API int add_property_zval_ex(zval *arg, const char *key, zend_string_size key_len, zval *value TSRMLS_DC) /* {{{ */
{
	zval *z_key;
...
ZEND_API int zend_register_functions(zend_class_entry *scope, const zend_function_entry *functions, HashTable *function_table, int type TSRMLS_DC) /* {{{ */
{
	...
	zend_string_size fname_len;
	const char *lc_class_name = NULL;
	zend_string_size class_name_len = 0;
...
ZEND_API int zend_register_class_alias_ex(const char *name, zend_string_size name_len, zend_class_entry *ce TSRMLS_DC) /* {{{ */
{
...
ZEND_API int zend_set_hash_symbol(zval *symbol, const char *name, zend_string_size name_length, zend_bool is_ref, int num_symbol_tables, ...) /* {{{ */
{
...
ZEND_API int zend_disable_function(char *function_name, zend_string_size function_name_length TSRMLS_DC) /* {{{ */
{
...
static int zend_is_callable_check_class(const char *name, zend_string_size name_len, zend_fcall_info_cache *fcc, int *strict_class, char **error TSRMLS_DC) /* {{{ */
{
	int ret = 0;
	zend_class_entry **pce;
	char *lcname = zend_str_tolower_dup(name, name_len);
...
ZEND_API zend_bool zend_is_callable_ex(zval *callable, zval *object_ptr, uint check_flags, char **callable_name, zend_string_size *callable_name_len, zend_fcall_info_cache *fcc, char **error TSRMLS_DC) /* {{{ */
{
	zend_bool ret;
	zend_string_size callable_name_len_local;
...
ZEND_API int zend_declare_property_ex(zend_class_entry *ce, const char *name, zend_string_size name_length, zval *property, int access_type, const char *doc_comment, zend_string_size doc_comment_len TSRMLS_DC) /* {{{ */
{
	...
	switch (access_type & ZEND_ACC_PPP_MASK) {
		case ZEND_ACC_PRIVATE: {
				char *priv_name;
				zend_string_size priv_name_length;
		...
		case ZEND_ACC_PROTECTED: {
				char *prot_name;
				zend_string_size prot_name_length;
...
ZEND_API int zend_declare_property(zend_class_entry *ce, const char *name, zend_string_size name_length, zval *property, int access_type TSRMLS_DC) /* {{{ */
{
	return zend_declare_property_ex(ce, name, name_length, property, access_type, NULL, 0 TSRMLS_CC);
}
/* }}} */

ZEND_API int zend_declare_property_null(zend_class_entry *ce, const char *name, zend_string_size name_length, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
...
ZEND_API int zend_declare_property_bool(zend_class_entry *ce, const char *name, zend_string_size name_length, long value, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
...
ZEND_API int zend_declare_property_long(zend_class_entry *ce, const char *name, zend_string_size name_length, long value, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
...
ZEND_API int zend_declare_property_double(zend_class_entry *ce, const char *name, zend_string_size name_length, double value, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
...
ZEND_API int zend_declare_property_string(zend_class_entry *ce, const char *name, zend_string_size name_length, const char *value, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
	zend_string_size len = strlen(value);
...
ZEND_API int zend_declare_property_stringl(zend_class_entry *ce, const char *name, zend_string_size name_length, const char *value, zend_string_size value_len, int access_type TSRMLS_DC) /* {{{ */
{
	zval *property;
...
ZEND_API int zend_declare_class_constant(zend_class_entry *ce, const char *name, zend_string_size name_length, zval *value TSRMLS_DC) /* {{{ */
{
	return zend_hash_update(&ce->constants_table, name, name_length+1, &value, sizeof(zval *), NULL);
}
/* }}} */

ZEND_API int zend_declare_class_constant_null(zend_class_entry *ce, const char *name, zend_string_size name_length TSRMLS_DC) /* {{{ */
{
	zval *constant;
...
ZEND_API int zend_declare_class_constant_long(zend_class_entry *ce, const char *name, zend_string_size name_length, long value TSRMLS_DC) /* {{{ */
{
	zval *constant;
...
ZEND_API int zend_declare_class_constant_bool(zend_class_entry *ce, const char *name, zend_string_size name_length, zend_bool value TSRMLS_DC) /* {{{ */
{
	zval *constant;
...
ZEND_API int zend_declare_class_constant_double(zend_class_entry *ce, const char *name, zend_string_size name_length, double value TSRMLS_DC) /* {{{ */
{
	zval *constant;
...
ZEND_API int zend_declare_class_constant_stringl(zend_class_entry *ce, const char *name, zend_string_size name_length, const char *value, zend_string_size value_length TSRMLS_DC) /* {{{ */
{
	zval *constant;
...
ZEND_API int zend_declare_class_constant_string(zend_class_entry *ce, const char *name, zend_string_size name_length, const char *value TSRMLS_DC) /* {{{ */
{
	return zend_declare_class_constant_stringl(ce, name, name_length, value, strlen(value) TSRMLS_CC);
}
/* }}} */

ZEND_API void zend_update_property(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, zval *value TSRMLS_DC) /* {{{ */
{
	zval *property;
	zend_class_entry *old_scope = EG(scope);
...
ZEND_API void zend_update_property_null(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API void zend_update_property_bool(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, long value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API void zend_update_property_long(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, long value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API void zend_update_property_double(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, double value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API void zend_update_property_string(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, const char *value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API void zend_update_property_stringl(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, const char *value, zend_string_size value_len TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property(zend_class_entry *scope, const char *name, zend_string_size name_length, zval *value TSRMLS_DC) /* {{{ */
{
	zval **property;
	zend_class_entry *old_scope = EG(scope);
...
ZEND_API int zend_update_static_property_null(zend_class_entry *scope, const char *name, zend_string_size name_length TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property_bool(zend_class_entry *scope, const char *name, zend_string_size name_length, long value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property_long(zend_class_entry *scope, const char *name, zend_string_size name_length, long value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property_double(zend_class_entry *scope, const char *name, zend_string_size name_length, double value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property_string(zend_class_entry *scope, const char *name, zend_string_size name_length, const char *value TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API int zend_update_static_property_stringl(zend_class_entry *scope, const char *name, zend_string_size name_length, const char *value, zend_string_size value_len TSRMLS_DC) /* {{{ */
{
	zval *tmp;
...
ZEND_API zval *zend_read_property(zend_class_entry *scope, zval *object, const char *name, zend_string_size name_length, zend_bool silent TSRMLS_DC) /* {{{ */
{
	zval *property, *value;
	zend_class_entry *old_scope = EG(scope);
...
ZEND_API const char* zend_find_alias_name(zend_class_entry *ce, const char *name, zend_string_size len) /* {{{ */
{
